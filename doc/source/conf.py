...
htmlhelp_basename = 'PlantScan3ddoc'
...
latex_documents = [
    (master_doc, 'PlantScan3d.tex', u'PlantScan3d Documentation',
     u'Frederic Boudon, Julien Benoit', 'manual'),
]
...
man_pages = [
    (master_doc, 'plantscan3d', u'PlantScan3d Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PlantScan3d', u'PlantScan3d Documentation',
     author, 'PlantScan3d', 'One line description of project.',
     'Miscellaneous'),
]