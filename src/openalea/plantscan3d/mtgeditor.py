...
class MTGEditor(QMainWindow, editor_ui.Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.actionRDensity.triggered.connect(self.mtgeditor.pointRDensity)
        self.actionRDensity_MT.triggered.connect(self.mtgeditor.pointRDensityMT)
        ...
        self.actionSoil.triggered.connect(self.mtgeditor.selectSoil)
        self.actionWire.triggered.connect(self.mtgeditor.selectWire)
        self.mtgeditor.wireAvailable.connect(self.actionWire.setEnabled)
        self.actionWire_KeepPoint.triggered.connect(self.mtgeditor.wireKeepPoint)
        self.actionPole.triggered.connect(self.mtgeditor.selectPole)
        ...
        self.backVisibilitySlider.valueChanged.connect(self.mtgeditor.setBackVisibility)
        self.frontVisibilitySlider.valueChanged.connect(self.mtgeditor.setFrontVisibility)
        ...
        self.pointFilterSlider.valueChanged.connect(self.mtgeditor.setPointFilter)
