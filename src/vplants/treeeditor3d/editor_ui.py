...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionAdaptiveScaReconstruction = QtGui.QAction(MainWindow)
        self.actionAdaptiveScaReconstruction.setEnabled(True)
        self.actionAdaptiveScaReconstruction.setObjectName(_fromUtf8("actionAdaptiveScaReconstruction"))
        ...
        self.actionClearRecents = QtGui.QAction(MainWindow)
        self.actionClearRecents.setObjectName(_fromUtf8("actionClearRecents"))
        self.actionGraphColonization = QtGui.QAction(MainWindow)
        self.actionGraphColonization.setObjectName(_fromUtf8("actionGraphColonization"))
        self.actionPointClusters = QtGui.QAction(MainWindow)
        self.actionPointClusters.setObjectName(_fromUtf8("actionPointClusters"))
        self.actionWhiteTheme = QtGui.QAction(MainWindow)
        self.actionWhiteTheme.setObjectName(_fromUtf8("actionWhiteTheme"))
        self.actionBlackTheme = QtGui.QAction(MainWindow)
        self.actionBlackTheme.setObjectName(_fromUtf8("actionBlackTheme"))
        self.actionScaReconstruction = QtGui.QAction(MainWindow)
        self.actionScaReconstruction.setObjectName(_fromUtf8("actionScaReconstruction"))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Plantscan3D", None))
        ...
        self.actionAdaptiveScaReconstruction.setText(_translate("MainWindow", "Adaptive Space Colonization", None))
        ...
        self.actionComputeMaxRadius.setText(_translate("MainWindow", "Estimate As Max Point Dist.", None))
        ...
        self.actionComputeMeanRadius.setText(_translate("MainWindow", "Estimate As Mean Point Dist", None))
        ...
        self.actionClearRecents.setText(_translate("MainWindow", "Clear", None))
        self.actionGraphColonization.setText(_translate("MainWindow", "Adaptive R. Graph Colonization", None))
        self.actionPointClusters.setText(_translate("MainWindow", "Clusters", None))
        self.actionWhiteTheme.setText(_translate("MainWindow", "White", None))
        self.actionBlackTheme.setText(_translate("MainWindow", "Black", None))
        self.actionScaReconstruction.setText(_translate("MainWindow", "Space Colonization", None))
